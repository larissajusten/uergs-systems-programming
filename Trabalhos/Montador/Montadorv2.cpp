			...
			case 2: /* Duas palavras - INST|VAR; INST|LABEL; LABEL|INST */
					...
					if((strtmp1 == "jmp") or (strtmp1 == "jeq") or (strtmp1 == "jgt") or (strtmp1 == "jlt")){ /* JUMP(strtmp1) LABEL(strtmp) */
						for(i=0; i < tbsym.size(); i++){	
							if(strtmp == tbsym[i].palavra){
								cout << "Label: " << strtmp << " ja esta na tabela." << endl;
								break;
							}
						}
						if(i == tbsym.size()){
							...
							n1.endr = countx;
							tbsym.push_back(n1);
							cout << "Label: " << strtmp << " adicionada na tabela." << endl;
						}
						...
						while(i != tbsym.size()){
							if(strtmp == tbsym[i].palavra){
								cout << "Variavel: " << strtmp << " encontrada." << endl;
								break;
							}
							i++;
						}
						if(i == tbsym.size()){
							cout << "Variavel: " << strtmp << " nao encontrada! Adicionar variavel!" << endl;
				...
				for(i=0; i < tbsym.size(); i++){
					if(strtmp1 == tbsym[i].palavra){
							cout << "Label: " << strtmp1 << " repetida." << endl;
				...
				if(i == tbsym.size()){
					...
					n1.endr = countx;
					tbsym.push_back(n1);
					cout << "Label: " << strtmp1 << " adicionada na tabela." << endl;
				}
			break;
				...
				if(linha[1] == "space"){
					...
					while(i != tbsym.size()){
						if(strtmp != tbsym[i].palavra){
							...
							cout << "Label: " << strtmp << " j?utilizada" << endl;
							exit(1);
						}
					}
					if(i==tbsym.size()){
					...
					for(i=0; i < tbsym.size(); i++){
						if(strtmp1 == tbsym[i].palavra){
							cout << "Variavel: " << strtmp1 << " repetida." << endl;
							break;
						}else if(strtmp1 != tbsym[i].palavra){
							cout << "Variavel: " << strtmp1 << " nao encontrada! Adicionar variavel!" << endl;
							cout << "Terminando o programa!" << endl;
							exit(1);
						}
					}			
